...
public class Civil2Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.civil2);
		
		buttonListener(R.id.go_home_bt, MainActivity.class);
		buttonListener(R.id.previous_bt, CivilActivity.class);
		buttonListener(R.id.next_bt, CpeActivity.class);
	    ...
	    InputStream iFile = getResources().openRawResource(R.raw.civil2);
	    try {
	        TextView helpText = (TextView) findViewById(R.id.text_civil2);
	...
	public void buttonListener(int idActivity , final Class<?> classname){
		...
		buttonName.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startActivity(new Intent(Civil2Activity.this, (Class<?>) classname ));
				Civil2Activity.this.finish();
			}
		});
	}
