...
public class Eee2Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.eee2);
		
		buttonListener(R.id.go_home_bt, MainActivity.class);
		buttonListener(R.id.previous_bt, EeeActivity.class);
		buttonListener(R.id.next_bt, EveActivity.class);
	    ...
	    InputStream iFile = getResources().openRawResource(R.raw.eee2);
	    try {
	        TextView helpText = (TextView) findViewById(R.id.text_eee2);
	...
	public void buttonListener(int idActivity , final Class<?> classname){
		...
		buttonName.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startActivity(new Intent(Eee2Activity.this, (Class<?>) classname ));
				Eee2Activity.this.finish();
			}
		});
	}
