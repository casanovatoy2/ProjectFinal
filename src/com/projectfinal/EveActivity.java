...
public class EveActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		buttonListener(R.id.previous_bt, Eee2Activity.class);
		buttonListener(R.id.next_bt, Eve2Activity.class);
	    ...
	    InputStream iFile = getResources().openRawResource(R.raw.eve1);
	    try {
	        TextView helpText = (TextView) findViewById(R.id.text_eve1);
	...
	public void buttonListener(int idActivity , final Class<?> classname){
		...
		buttonName.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startActivity(new Intent(EveActivity.this, (Class<?>) classname ));
				EveActivity.this.finish();
			}
		});
	}
