...
public class MajorActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		buttonListener(R.id.previous_bt, Ie2Activity.class);
		buttonListener(R.id.next_bt, CivilActivity.class);

		Typeface THSarabunNew = Typeface.createFromAsset(getAssets(),
				"fonts/THSarabunNew.ttf");

		// Read raw file into string and populate TextView
		InputStream iFile = getResources().openRawResource(R.raw.major);
		try {
			TextView helpText = (TextView) findViewById(R.id.text_major);
	...
	public void buttonListener(int idActivity, final Class<?> classname) {
		...
		buttonName.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				startActivity(new Intent(MajorActivity.this,
						(Class<?>) classname));
