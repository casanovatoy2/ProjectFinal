...
public class AdmissionActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    InputStream iFile = getResources().openRawResource(R.raw.admission);
	    try {
	        TextView helpText = (TextView) findViewById(R.id.text_admission2);
	...
	public void buttonListener(int idActivity, final Class<?> classname) {
		...
		buttonName.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				startActivity(new Intent(AdmissionActivity.this,(Class<?>) classname));
