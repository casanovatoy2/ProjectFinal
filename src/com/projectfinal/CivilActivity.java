...
public class CivilActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		buttonListener(R.id.previous_bt, MajorActivity.class);
		buttonListener(R.id.next_bt, Civil2Activity.class);
	    ...
	    InputStream iFile = getResources().openRawResource(R.raw.civil1);
	    try {
	        TextView helpText = (TextView) findViewById(R.id.text_civil);
	...
	public void buttonListener(int idActivity , final Class<?> classname){
		...
		buttonName.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startActivity(new Intent(CivilActivity.this, (Class<?>) classname ));
				CivilActivity.this.finish();
			}
		});
	}
