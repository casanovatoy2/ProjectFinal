...
public class EeeActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		buttonListener(R.id.previous_bt, Cpe2Activity.class);
		buttonListener(R.id.next_bt, Eee2Activity.class);
	    ...
	    InputStream iFile = getResources().openRawResource(R.raw.eee1);
	    try {
	        TextView helpText = (TextView) findViewById(R.id.text_eee);
	...
	public void buttonListener(int idActivity , final Class<?> classname){
		...
		buttonName.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startActivity(new Intent(EeeActivity.this, (Class<?>) classname ));
				EeeActivity.this.finish();
			}
		});
	}
