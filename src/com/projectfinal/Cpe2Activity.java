...
public class Cpe2Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cpe2);
		
		buttonListener(R.id.go_home_bt, MainActivity.class);
		buttonListener(R.id.previous_bt, CpeActivity.class);
		buttonListener(R.id.next_bt, EeeActivity.class);
	    ...
	    InputStream iFile = getResources().openRawResource(R.raw.cpe2);
	    try {
	        TextView helpText = (TextView) findViewById(R.id.text_cpe2);
...
public String inputStreamToString(InputStream is) throws IOException 
{
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.cpe, menu);
		return true;
	}
	public void buttonListener(int idActivity , final Class<?> classname){
		...
		buttonName.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startActivity(new Intent(Cpe2Activity.this, (Class<?>) classname ));
				Cpe2Activity.this.finish();
			}
		});
	}
}
