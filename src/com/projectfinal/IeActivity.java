...
public class IeActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		buttonListener(R.id.previous_bt, Eve2Activity.class);
		buttonListener(R.id.next_bt, Ie2Activity.class);
	    ...
	    InputStream iFile = getResources().openRawResource(R.raw.ie1);
	    try {
	        TextView helpText = (TextView) findViewById(R.id.text_ie1);
	...
	public void buttonListener(int idActivity , final Class<?> classname){
		...
		buttonName.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startActivity(new Intent(IeActivity.this, (Class<?>) classname ));
				IeActivity.this.finish();
			}
		});
	}
