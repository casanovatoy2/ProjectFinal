...
public class Ie2Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ie2);
		
		buttonListener(R.id.go_home_bt, MainActivity.class);
		buttonListener(R.id.previous_bt, IeActivity.class);
		buttonListener(R.id.next_bt, MajorActivity.class);
	    ...
	    InputStream iFile = getResources().openRawResource(R.raw.ie2);
	    try {
	        TextView helpText = (TextView) findViewById(R.id.text_ie2);
	...
	public void buttonListener(int idActivity , final Class<?> classname){
		...
		buttonName.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startActivity(new Intent(Ie2Activity.this, (Class<?>) classname ));
				Ie2Activity.this.finish();
			}
		});
	}
