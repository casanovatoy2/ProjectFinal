...
public class AboutUsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		InputStream iFile = getResources().openRawResource(R.raw.aboutme);
		try {
			TextView helpText = (TextView) findViewById(R.id.text_about_us);
	...
	public void buttonListener(int idActivity, final Class<?> classname) {
		...
		buttonName.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				startActivity(new Intent(AboutUsActivity.this,(Class<?>) classname));
